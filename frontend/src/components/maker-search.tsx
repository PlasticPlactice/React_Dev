...
const Maker_search = () => {
    return(
        <ul className="flex justify-start bg-white border-b-2">
            ...
            <li className="w-24 h-28">
                <MakeItem MakerName={"スズキ"} src={"/img/maker/Suzuki.png"} alt={"Suzuki"}/>
            </li>
            <li className="w-24 h-28">
                <MakeItem MakerName={"ダイハツ"} src={"/img/maker/Daihatsus.png"} alt={"Daihatsu"}/>
            </li>
            <li className="w-24 h-28">
                <MakeItem MakerName={"マツダ"} src={"/img/maker/Mazda.png"} alt={"Mazda"}/>
            </li>
            <li className="w-24 h-28">
                <MakeItem MakerName={"スバル"} src={"/img/maker/Subaru.png"} alt={"Subaru"}/>
            </li>
            <li className="w-24 h-28">
                <MakeItem MakerName={"三菱"} src={"/img/maker/Mitsubishi.jpg"} alt={"Mitsubishi"}/>
            </li>
        </ul>
    )
}
